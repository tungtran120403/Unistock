...
import { previewImport, importExcel, downloadMaterialTemplate } from "./materialService";
...
const ImportMaterialModal = ({ open, onClose, onSuccess }) => {
    ...
    // Định nghĩa các header mong đợi từ template vật tư
    const expectedHeaders = ["Mã vật tư", "Tên vật tư", "Đơn vị", "Danh mục", "Tên nhà cung cấp", "Mô tả"];

    // Hàm kiểm tra định dạng template Excel
    ...
    const handleDownloadTemplate = async () => {
        try {
            ...
            link.href = url;
            link.setAttribute("download", "template_import_vattu.xlsx");
                                ...
                                <table className="w-full text-sm text-left border-collapse">
                                    <thead>
                                        <tr className="bg-gray-100">
                                            <th className="border px-2 py-1">Dòng số</th>
                                            <th className="border px-2 py-1">Mã vật tư</th>
                                            <th className="border px-2 py-1">Tên vật tư</th>
                                    ...
                                    <tbody>
                                        {paginatedData.map((row, idx) => (
                                            <tr key={idx}>
                                                ...
                                                <td className="border px-2 py-1">{row.materialCode}</td>
                                                <td className="border px-2 py-1">{row.materialName}</td>
                                                <td className="border px-2 py-1">{row.unitName}</td>
                                                <td className="border px-2 py-1">{row.materialTypeName}</td>
                                                <td className="border px-2 py-1">{row.partnerName}</td>
